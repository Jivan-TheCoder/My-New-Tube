...
class FeedDatabaseManager(context: Context) {
    ...
    fun notLoadedCount(groupId: Long = FeedGroupEntity.Companion.GROUP_ALL_ID): Flowable<Long> {
        return when (groupId) {
            FeedGroupEntity.Companion.GROUP_ALL_ID -> feedTable.notLoadedCount()
    ...
    fun oldestSubscriptionUpdate(groupId: Long): Flowable<List<OffsetDateTime?>> {
        return when (groupId) {
            FeedGroupEntity.Companion.GROUP_ALL_ID -> feedTable.oldestSubscriptionUpdateFromAll()
