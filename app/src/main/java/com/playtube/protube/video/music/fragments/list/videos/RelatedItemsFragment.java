package com.playtube.protube.video.music.fragments.list.videos;
...
import com.playtube.protube.video.music.databinding.RelatedItemsHeaderBinding;
...
import com.playtube.protube.video.music.ktx.ViewUtils;
...
public class RelatedItemsFragment extends BaseListInfoFragment<InfoItem, RelatedItemsInfo>
    ...
    protected NativeAdInjectionConfig getNativeAdInjectionConfig() {
        return NativeAdInjectionConfig.interval((AdUtils.base_after + 1), AdUtils.rel_every)
