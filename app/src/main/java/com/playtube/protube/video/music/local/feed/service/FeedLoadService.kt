...
class FeedLoadService : Service() {
    companion object {
        ...
        private const val ACTION_CANCEL = App.Companion.PACKAGE_NAME + ".local.feed.service.FeedLoadService.CANCEL"
    ...
    override fun onStartCommand(intent: Intent?, flags: Int, startId: Int): Int {
        ...
        val groupId = intent.getLongExtra(EXTRA_GROUP_ID, FeedGroupEntity.Companion.GROUP_ALL_ID)
