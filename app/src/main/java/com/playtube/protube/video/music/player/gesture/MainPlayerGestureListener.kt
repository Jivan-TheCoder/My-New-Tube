package com.playtube.protube.video.music.player.gesture
...
class MainPlayerGestureListener(
    ...
    override fun onScroll(
        ...
        val statusBarHeight = ThemeHelper.getAndroidDimenPx(player.context, "status_bar_height")
        val navigationBarHeight =
            ThemeHelper.getAndroidDimenPx(player.context, "navigation_bar_height")
