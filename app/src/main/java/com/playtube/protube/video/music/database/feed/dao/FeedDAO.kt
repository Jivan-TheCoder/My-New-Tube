package com.playtube.protube.video.music.database.feed.dao
...
abstract class FeedDAO {
     ...
     * @see StreamStateEntity.Companion.PLAYBACK_FINISHED_END_MILLISECONDS
     * @see StreamStateEntity.Companion.PLAYBACK_SAVE_THRESHOLD_START_MILLISECONDS
     */
    @Query(
        """
        ...
        ON (
            :groupId <> ${FeedGroupEntity.Companion.GROUP_ALL_ID}
        ...
        AND (
            ...
            OR sst.progress_time < s.duration * 1000 - ${StreamStateEntity.Companion.PLAYBACK_FINISHED_END_MILLISECONDS}
        ...
        AND (
            ...
            OR sh.stream_id IS NULL
            OR sst.stream_id IS NULL
            OR (sst.progress_time <= ${StreamStateEntity.Companion.PLAYBACK_SAVE_THRESHOLD_START_MILLISECONDS}
