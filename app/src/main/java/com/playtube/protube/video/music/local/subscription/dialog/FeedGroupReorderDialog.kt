...
import com.playtube.protube.video.music.local.subscription.item.FeedGroupReorderItem
import com.playtube.protube.video.music.util.ThemeHelper
import com.xwray.groupie.GroupieAdapter
import com.xwray.groupie.TouchCallback
import java.util.Collections
import com.playtube.protube.video.music.R
import com.playtube.protube.video.music.databinding.DialogFeedGroupReorderBinding
...
class FeedGroupReorderDialog : DialogFragment() {
    ...
    override fun onViewCreated(view: View, savedInstanceState: Bundle?) {
        ...
        viewModel.dialogEventLiveData.observe(viewLifecycleOwner) {
            when (it) {
                FeedGroupReorderDialogViewModel.DialogEvent.ProcessingEvent -> disableInput()
                FeedGroupReorderDialogViewModel.DialogEvent.SuccessEvent -> dismiss()
            }
        }
