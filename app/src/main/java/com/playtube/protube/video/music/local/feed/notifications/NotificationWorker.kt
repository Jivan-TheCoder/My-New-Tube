package com.playtube.protube.video.music.local.feed.notifications
...
import com.playtube.protube.video.music.local.feed.service.FeedLoadManager
...
class NotificationWorker(
    ...
    override fun createWork(): Single<Result> = if (areNotificationsEnabled(applicationContext)) {
        feedLoadManager.startLoading(
            ...
            groupId = FeedLoadManager.Companion.GROUP_NOTIFICATION_ENABLED
        )
            ...
            .doOnError { throwable ->
                ...
                ErrorUtil.Companion.createNotification(
                    applicationContext,
    ...
    private fun showLoadingFeedForegroundNotification() {
        ...
        setForegroundAsync(ForegroundInfo(FeedLoadService.Companion.NOTIFICATION_ID, notification, serviceType))
    }

    companion object {

        private val TAG = NotificationWorker::class.java.simpleName
        private const val WORK_TAG = App.Companion.PACKAGE_NAME + "_streams_notifications"
