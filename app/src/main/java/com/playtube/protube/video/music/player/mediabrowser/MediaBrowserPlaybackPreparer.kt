 ...
 * [com.playtube.protube.video.music.player.PlayerService]) and the playback preparer implementation (in this
...
class MediaBrowserPlaybackPreparer(
    ...
    private fun onPrepareError(throwable: Throwable) {
        setMediaSessionError.accept(
            ErrorInfo.Companion.getMessage(throwable, null, null).getText(context),
