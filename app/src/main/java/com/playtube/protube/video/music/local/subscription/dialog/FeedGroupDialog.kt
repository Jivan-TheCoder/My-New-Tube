package com.playtube.protube.video.music.local.subscription.dialog
...
import com.playtube.protube.video.music.local.subscription.item.PickerIconItem
import com.playtube.protube.video.music.local.subscription.item.PickerSubscriptionItem
...
import com.playtube.protube.video.music.databinding.DialogFeedGroupCreateBinding
import com.playtube.protube.video.music.databinding.ToolbarSearchLayoutBinding
...
class FeedGroupDialog : DialogFragment(), BackPressable {
    ...
    override fun onViewCreated(view: View, savedInstanceState: Bundle?) {
        ...
        viewModel.dialogEventLiveData.observe(viewLifecycleOwner) {
            when (it) {
                FeedGroupDialogViewModel.DialogEvent.ProcessingEvent -> disableInput()
                FeedGroupDialogViewModel.DialogEvent.SuccessEvent -> dismiss()
            }
        }
    ...
    private fun showScreen(screen: ScreenState) {
        ...
        feedGroupCreateBinding.separator.onlyVisibleIn(
            ScreenState.SubscriptionsPickerScreen,
            ScreenState.IconPickerScreen
        )
        feedGroupCreateBinding.cancelButton.onlyVisibleIn(
            ScreenState.InitialScreen,
            ScreenState.DeleteScreen
        )
