 ...
 * player) is running and is bound to {@link PlayerHolder}.
 * "Disconnected" means that either the service (resp. the player) was stopped completely, or that
 * {@link PlayerHolder} is not bound.
 */
public interface PlayerServiceExtendedEventListener extends PlayerServiceEventListener {
    /**
     * The player service just connected to {@link PlayerHolder},
     ...
     * completely, or {@link PlayerHolder} is unbinding.
     */
    void onPlayerDisconnected();

    /**
     * The service got disconnected from {@link PlayerHolder},
     * either because {@link PlayerHolder} is unbinding or because
